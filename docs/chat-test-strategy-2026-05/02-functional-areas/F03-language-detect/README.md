# F03 — Language detect (browser + URL + cookie + heuristique darija)
...
- Voir la ligne **F03** dans [00-matrix.csv](../_index/00-matrix.csv) : compteurs par couche, coverage target, tags.
