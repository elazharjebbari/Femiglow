# F04 — Composer input (validation + Enter shortcut + paste handling)
...
- Voir la ligne **F04** dans [00-matrix.csv](../_index/00-matrix.csv) : compteurs par couche, coverage target, tags.
