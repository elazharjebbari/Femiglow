...
export const SITE_COMPONENT_REGISTRY: SiteComponentSeed[] = [
  ...
  /* ───── Kit ───── */
  {
    key: 'global-promo-slide-header',
    name: 'Sticky promo Kit',
    description:
      'Sticky header promotionnel de la page /kit, pilote par admin: message court, tags de reassurance, style et comportement.',
    category: 'banner',
    pageGroup: 'kit',
    filePath: 'src/components/promo/GeoPromoSlideHeader.tsx',
    slots: [],
    defaultSvgFallback: null,
    defaultLoadingStrategy: 'eager',
    defaultFetchPriority: 'auto',
    supportsAnimation: false,
    metadata: { routeScope: '/kit', adminFirst: true },
    fields: [
      {
        key: 'enabled',
        label: 'Activer le sticky /kit',
        type: 'boolean',
        required: true,
        defaultValue: true,
        group: 'Activation',
      ...
      {
        key: 'routesInclude',
        label: 'Routes incluses',
        type: 'list',
        required: true,
        defaultValue: ['/kit'],
        group: 'Activation',
        order: 2,
        config: { itemType: 'text', minItems: 1, maxItems: 1 },
      },
      {
        key: 'routesExclude',
        label: 'Routes exclues',
        type: 'list',
        required: false,
        defaultValue: ['/checkout', '/admin', '/api'],
        group: 'Activation',
        order: 3,
        config: { itemType: 'text', maxItems: 6 },
      },
      {
        key: 'messageTemplate',
        label: 'Message avec ville',
        type: 'text',
        required: true,
        defaultValue: 'Offre du {dateShort} - {city}',
        group: 'Contenu',
        order: 10,
        config: { maxLength: 80 },
      },
      {
        key: 'fallbackMessageTemplate',
        label: 'Message sans ville',
        type: 'text',
        required: true,
        defaultValue: 'Offre du {dateShort} - Maroc',
        group: 'Contenu',
        order: 11,
        config: { maxLength: 80 },
      },
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        defaultValue: '/kit#commander-femiglow',
        group: 'Contenu',
        order: 13,
        config: { maxLength: 80 },
      },
      {
        key: 'ariaLabel',
        label: 'Libelle accessible',
        type: 'text',
        required: false,
        defaultValue: 'Offre FemiGlow du jour',
        group: 'Contenu',
        order: 14,
        config: { maxLength: 80 },
      },
      ...
      },
      {
        ...
        group: 'Tags',
        order: 21,
        config: { itemType: 'text', minItems: 1, maxItems: 5 },
      },
      {
        key: 'theme',
        label: 'Theme',
      ...
      },
      {
        ...
        type: 'text',
        required: true,
        defaultValue: 'geo_promo_kit_default',
        group: 'Analytics',
        order: 50,
        config: { maxLength: 80 },
      },
