 ...
 * `Step 4`, `Polish & Shine`, `FemiGlow`, `MAD`, `INCI`. Lexique :
...
export const mockRituelAr: RituelPageContent = {
  ...
  origine: {
    ...
    paragraphes: [
      'في اليابان، العناية باليد ليست منتجا: هي انتباه يومي، بطيء، دون إعلان. المانيكور الياباني — المعروف أيضا بـ«kawaii» أو «chigiri» — يعود إلى مطلع القرن العشرين. يكشف اللمعان الطبيعي للظفر بالتلميع، دون طلاء.',
  ...
  videoGestes: {
    ...
    poster: {
      ...
      alt: 'الحركة الأولى من الطقوس: حبّة بحجم البندقة من Paste، موضوعة',
      width: 1920,
      height: 1080,
    },
    captions: {
  ...
  sciences: {
    ...
    essais: [
      ...
      },
      {
        ...
        paragraphe:
          'تتبّع الموادّ، غياب الكحول المُحوَّل، غياب المشتقّات الحيوانية غير المطابقة. الشارة تتبع تدقيقا من Halal Cosmetics Council³.',
        sourceRef: '[3]',
      },
    ],
    sourcesAcademiques: [
    ...
    questions: [
      {
        ...
        reponse:
          'علّمني المختبر INCI. علّمتني الحركة الصبر. الاثنان يكمّلان بعضهما — وهذا ما أنقله في تكويناتي بالرباط.',
      },
      {
        id: 'q2',
      ...
      },
      {
        ...
        reponse:
          'ابدئي بـPaste. لأسبوع، لا شيء غيرها. ستَرَين ما تقوله لكِ أظافرك. المُلمِّع يأتي بعد ذلك.',
      },
    ],
  },
