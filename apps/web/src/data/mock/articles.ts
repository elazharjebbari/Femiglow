...
export const mockArticles: Article[] = [
  {
    ...
    kicker: 'Saison',
    excerpt:
      'Le froid sec de Casablanca dessèche tout ce qui résiste. Les ongles plient, mais ne cassent pas — à condition de ralentir.',
    category: 'saison',
    ...
    author: {
      name: 'Salma F.',
      bio: 'Fondatrice de la maison FemiGlow. Écrit depuis Casablanca, à voix basse, sur le soin lent et les matières du Maghreb.',
    },
    body: `Quand l\u2019air sec descend sur Casablanca en janvier, on cesse d\u2019attendre des ongles qu\u2019ils brillent. On leur demande de tenir. C\u2019est un changement d\u2019accord, presque imperceptible, et il fait toute la diff\u00e9rence.
...
L\u2019hiver casablancais n\u2019est pas un hiver de neige. C\u2019est un hiver de vent. L\u2019air vient du nord-est, traverse la m\u00e9diterran\u00e9e, atterrit sur la c\u00f4te avec une humidit\u00e9 trompeuse. La peau ne s\u2019y trompe pas. Les cuticules, encore moins.
...
Pour aller plus loin, le [rituel de quatre gestes](/rituel) est document\u00e9 pas \u00e0 pas. Pour comprendre pourquoi le sourcing direct compte aussi, l\u2019article [L\u2019huile d\u2019argan, vraie](/journal/huile-d-argan-vraie) ouvre l\u2019atelier. Et si vous \u00eates curieuses de la recherche en cosm\u00e9tique douce, le [rapport 2024 de la SOFW](https://www.sofw.com/) reste une r\u00e9f\u00e9rence accessible.
...
L\u2019hiver finit par passer. Les ongles auront \u00e9cout\u00e9 ; \u00e0 nous, simplement, d\u2019avoir \u00e9cout\u00e9 avec eux.`,
  ...
  {
    slug: 'cinq-minutes-le-soir',
    title: 'Cinq minutes, le soir',
    kicker: 'Pratique',
    excerpt:
      'Le rituel a sa fenêtre. Ni trop tôt, ni trop tard. Pourquoi le soir s\u2019y prête particulièrement.',
    category: 'pratique',
    ...
    featuredImage: {
      ...
      alt: 'Mains posées sur un plaid, lumière de lampe',
      width: 1600,
      height: 1067,
    },
    author: { name: 'Salma F.' },
    body: 'Le bon moment pour soigner ses ongles.',
    isFeatured: false,
    wordCount: 700,
    seo: { noIndex: false },
  },
  {
    ...
    kicker: 'Maison',
    excerpt:
      'L\u2019atelier de Casablanca change de souffle quand l\u2019orange fleurit. Visite d\u2019un mois où la lumière revient.',
    category: 'maison',
    ...
    featuredImage: {
      ...
      alt: 'Atelier de Casablanca, lumière du matin sur une table en bois',
      width: 1600,
      height: 1067,
    },
    author: { name: 'Salma F.' },
  ...
  },
  {
    ...
    kicker: 'Maison',
    excerpt:
      'Quartier des Habous, Casablanca. Comment on est arrivés ici, et ce qu\u2019on y fabrique.',
    category: 'maison',
    ...
    author: { name: 'Salma F.' },
    body: 'L\u2019atelier de Casablanca, en détail.',
    isFeatured: false,
    wordCount: 1600,
    seo: { noIndex: false },
  },
