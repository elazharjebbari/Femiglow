...
export const DEFAULT_KIT_VIDEO_COVER_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1920" preserveAspectRatio="xMidYMid slice" role="img" aria-labelledby="cover-title">
<title id="cover-title">Ambiance maison FemiGlow</title>
<defs>
